...
- **URL:** [  🚀 دیپلوی tetrashop-commercial-platform روی Vercel...
    ❌ دیپلوی ناموفق!
...
Vercel CLI 58.5.1 (Node.js 26.4.0)
  ...
  Directory       ~/github/tetrashop-commercial-platform
...
✓ Linked          ramin-edjlal-s-projects/tetrashop-commercial-platform

Retrieving project…
> Downloading `development` environment variables for ramin-edjlal-s-projects/tetrashop-commercial-platform
Downloading

✓ Created         .env.local file and added it to .gitignore
Deploying ramin-edjlal-s-projects/tetrashop-commercial-platform
Uploading [--------------------] (0.0B/3.8KB)
Uploading [====================] (3.8KB/3.8KB)
Error: Resource is limited - try again in 24 hours (more than 100, code: "api-deployments-free-per-day").](  🚀 دیپلوی tetrashop-commercial-platform روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
<!-- Trigger deploy: Mon Aug 17 01:49:56 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://tetrashop-commercial-platform.vercel.app](https://tetrashop-commercial-platform.vercel.app)
- **وضعیت:** ✅ فعال
